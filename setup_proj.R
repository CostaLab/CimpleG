...
# suggested
import_tag <- "Imports" # suggests
usethis::use_package("devtools", import_tag)
...
usethis::use_package("PMCMRplus", import_tag)
...
usethis::use_package("ggplot2", import_tag)
usethis::use_package("ggExtra", import_tag)
usethis::use_package("ggrepel", import_tag)
usethis::use_package("circlize", import_tag)
usethis::use_package("NMF", import_tag)
usethis::use_package("gtools", import_tag)
usethis::use_package("nnls", import_tag)
usethis::use_package("RColorBrewer", import_tag)
usethis::use_package("forcats", import_tag)
usethis::use_package("future.apply", import_tag)
usethis::use_package("ggbeeswarm", import_tag)
usethis::use_package("ggsci", import_tag)
usethis::use_package("patchwork", import_tag)
...
usethis::use_package("archive", import_tag)
